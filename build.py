...
def fetch_ci_time(filePath):
    entries = httpx.get("https://api.github.com/repos/hell0bird/sec_weekly/commits?path=" + filePath + "&page=1&per_page=1")
